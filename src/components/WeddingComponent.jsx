...
export default function WeddingComponent() {
    return (
        <div className="flex flex-col lg:flex-row items-center lg:items-start p-4 sm:p-8 lg:p-16 space-y-8 lg:space-y-0 lg:space-x-16 max-w-5xl mx-auto">
            <div className="text-center lg:text-left lg:w-1/2 space-y-4 sm:space-y-6">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl text-green-900 font-bold">Leticia & Junio</h1>
